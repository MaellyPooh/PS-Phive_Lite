...
function kernelExploit() {
 ...
 var trigger_spray = function () {
  ...
  if(espMode == "1" || espMode == "2"){
   ...
   cacheUPDtxt.innerHTML = "Jailbreaking, please wait... "+timeleft/1000;
   var downloadTimer = setInterval(function(){
    if(timeleft <= 1000){
	 cacheUPDtxt.innerHTML="Jailbreaking, please wait... <span style='font-family:monospace;opacity:0;'>0.0</span>";
     ...
     setTimeout(function(){
      ...
      cacheUPDtxt.innerHTML="Kernel exploit failed! Reboot and try again.<br>Press X before loading the exploit <br>to access ESP settings.";
      alert("Kernel exploit failed! Reboot and try again."); 
     }
    },100);	
   }
   else{disptime=timeleft/1000;cacheUPDtxt.innerHTML="Jailbreaking, please wait... <span style='font-family:monospace'>"+disptime.toFixed(1)+"</span>";}
   timeleft -= 100;
   },100);
  }
  else {
